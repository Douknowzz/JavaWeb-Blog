			...
			<div class="row c_center">
				<div class="col-md-3" id="left_content">
					<div id="title">
						...
						<h5 class="text-muted">To be, or not to be, that is the question</h5>
					</div>
					<div class="c_center" id="person_info">
						<img src="../img/header.jpg" height="130" width="130" alt="丢失了我的头像?" class="img-circle">
						<h4 class="text-muted">${user.user_name}</h4>
						<h5 class="text-muted">小组长是无辜的.</h5>
					</div>
...
<%--							<span class="label label-info"><a href="/Blog/TagsServlet?get=${t.tag}">--%>
										<span class="label label-info"><a href="/TagsServlet?get=${t.tag}">&nbsp;${t.tag}&nbsp;</a></span>
									</c:when>
									<c:otherwise>
<%--								<span class="label label-success"><a href="/Blog/TagsServlet?get=${t.tag}">--%>
									<span class="label label-success"><a href="/TagsServlet?get=${t.tag}">&nbsp;${t.tag}&nbsp;</a></span>
									</c:otherwise>
								</c:choose>
							</c:forEach><!-- 初始化标签完成 -->
						</div>
					...
					<c:if test="${sessionScope.user!=null}">
						<a href="/AddServlet"><span class="glyphicon glyphicon-plus">&nbsp;&nbsp;写新文章&nbsp;&nbsp;</span></a>
						<br/><br/>
						<a href="/AdminServlet"><span class="glyphicon glyphicon glyphicon-user">&nbsp;&nbsp;管理更多&nbsp;&nbsp;</span></a>
					</c:if>
				</div>
