...
<%--			<div id="title"><h2><a href="/Blog/index.jsp">MyBlog</a></h2>					--%>
			<div id="title"><h2><a href="">MyBlog</a></h2></div>
...
<%--		   			<span class="help">id</span>--%>
		   			<input type="hidden" class="form-control" name="id"  value="${edit_article.id}">
		   			<!-- title -->
                ...
                <div class="editormd" id="mdView">                
                    <textarea style="min-height: 500px; width: 100%" name="content">${edit_article.content}</textarea>
                </div>
                <br/>
